O0_CFLAGS += -mcpu=cortex-m4

O0_CFLAGS  = -ggdb -O0 -Wall -Wextra -Warray-bounds
O0_CFLAGS += -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork
O0_CFLAGS += -mfloat-abi=hard -mfpu=fpv4-sp-d16
O0_CFLAGS += -DUSE_STDPERIPH_DRIVER -DSTM32F4XX -DSTM32F401xE
O0_CFLAGS += -ffunction-sections -fdata-sections
O0_CFLAGS += -Wl,--gc-sections -Wl,-Map=$(PROJ_NAME).map
